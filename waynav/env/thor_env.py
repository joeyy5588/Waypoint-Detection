...
from waynav.gen import constants as constants
from waynav.env.tasks import get_task
from waynav.gen.utils import image_util as image_util
from waynav.gen.utils import game_util
from waynav.gen.utils.game_util import get_objects_of_type, get_obj_of_type_closest_to_obj
...
class ThorEnv(Controller):
    ...
    def __init__(self, x_display=constants.X_DISPLAY,
        ...
        self.start(player_screen_height=player_screen_height,
                   player_screen_width=player_screen_width)
        self.task = None
