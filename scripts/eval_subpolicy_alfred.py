...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default="/home/ubuntu/alfred/data/json_2.1.0/valid_unseen")
    parser.add_argument('--save_path', type=str, default="/home/ubuntu/data/output/test_waynav/valid_unseen_gtsub")
    parser.add_argument('--metadata_path', type=str, default="/home/ubuntu/data/alfred_metadata/")
    parser.add_argument('--debug_dir', type=str, default="/home/ubuntu/data/output/test_waynav/valid_unseen_gtsub")
    ...
    parser.add_argument('--navigation_gpu', type=int, default=2)
    parser.add_argument('--detection_gpu', type=int, default=3)
