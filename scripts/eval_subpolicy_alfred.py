...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default="/home/ubuntu/data/output/test_waynav/valid_seen")
    parser.add_argument('--metadata_path', type=str, default="/home/ubuntu/data/alfred_metadata/")
    parser.add_argument('--debug_dir', type=str, default="/home/ubuntu/data/output/test_waynav/valid_seen")
